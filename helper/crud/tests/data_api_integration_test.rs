...
const CRUD_COMPONENT: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/target/wasm32-wasip2/release/deps/crud_component.wasm"
));
const DATA_API_COMPONENT: &[u8] = include_bytes!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/data-api/target/wasm32-wasip2/release/deps/data_api_component.wasm"
));
...
async fn start_workload_with_config(
    ...
    let req = WorkloadStartRequest {
        ...
        workload: Workload {
            ...
            components: vec![
                Component {
                    bytes: bytes::Bytes::from_static(CRUD_COMPONENT),
...
impl DataApi for DataGrpcServer {
    async fn execute(
        &self,
        _request: Request<DataApiRequest>,
